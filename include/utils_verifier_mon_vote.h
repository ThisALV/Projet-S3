/// \file
/// \brief Fonctions utilisees par le programme verifier_mon_vote, mises dans un module
...
/// \brief Taille de la chaine de caractere contenant la cle privee, \0 exclu
#define TAILLE_CLE_PRIVEE 80
/// \brief Taille d'un hash d'electeur present dans un fichier de ballots, \0 exclu.
/// 32 octets, chaque octet est represente en hexadecimal donc sur 2 chiffres [0-9a-f].
#define TAILLE_HASH_ELECTEUR 64


/// \brief Genere une chaine de caracteres alphanumerique aleatoire d'une longueur de 80,
...
/// \brief Genere le hash de l'electeur auquel on a concatene a la cle privee
...
/// \brief Ecrit la matrice de mots CSV dans le fichier ouvert en ecriture, en separant
...
/// \brief Dans la matrice de mots CSV donnee, chiffre les noms des electeurs et ecrit
...
/// \brief Cherche dans la matrice CSV les noms et scores des candidats pour lequel
